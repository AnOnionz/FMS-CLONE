...
class UpdateGeneralUseCase extends UseCase<GeneralEntity, AttendanceEntity?> {
  final GeneralRepository repository;

  UpdateGeneralUseCase(this.repository);
  @override
  Future<Result<GeneralEntity>> call(AttendanceEntity? params) {
    return repository.updateAttedanceInfo(params);
  }
}
