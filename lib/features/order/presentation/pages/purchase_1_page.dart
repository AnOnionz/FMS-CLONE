...
class OrderPurchase1Page extends StatefulWidget {
  final VoidCallback onNext;
  final VoidCallback onBack;
  final void Function(List<PurchaseEntity> purchases) onSaveData;

  const OrderPurchase1Page(
      {super.key,
  ...
  @override
  State<OrderPurchase1Page> createState() => _OrderPurchase1PageState();
}

class _OrderPurchase1PageState extends State<OrderPurchase1Page> {
  late final products =
  ...
  void didChangeDependencies() {
    products.forEach((product) {
      selectedItems[product] = PurchaseEntity(
        featureOrderProductId: product.id,
